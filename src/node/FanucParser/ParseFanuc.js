...
const RobotFrame_1 = require("./RobotFrame");
...
class ParseFanuc {
    ...
    parseLS(file) {
        ...
        while (match != null) {
            ...
            var type = RobotFrame_1.FrameType.Unknown;
            switch (match[7]) {
                case "TOOL":
                    type = RobotFrame_1.FrameType.Tool;
                    break;
                case "FRAME":
                    type = RobotFrame_1.FrameType.Frame;
                    break;
                default:
                    debugger;
                    type = RobotFrame_1.FrameType.Unknown;
                    break;
            }
            ...
            var frame = new RobotFrame_1.RobotFrame(match[0], file, type, num, x, y, z, w, p, r);
            addFrame(frame);
    ...
    parseText(file) {
        ...
        while (match != null) {
            ...
            var frame = new RobotFrame_1.RobotFrame(match[0], file, RobotFrame_1.FrameType.Frame, num, x, y, z, w, p, r);
            addFrame(frame);
        ...
        while (match != null) {
            ...
            var p = Number(match[7]);
            var r = Number(match[8]);
            var frame = new RobotFrame_1.RobotFrame(match[0], file, RobotFrame_1.FrameType.Tool, num, x, y, z, w, p, r);
            addFrame(frame);
...
ParseFanuc.frames = new Array();
exports.ParseFanuc = ParseFanuc;
//# sourceMappingURL=ParseFanuc.js.map